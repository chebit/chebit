...
```
# Просмотрит весь access.log и для каждой строки, в которой присутсвует слово index.html запустит команду echo с параметром в виде полного содержимого этой строки. Завершится после прохождения всего файла.
